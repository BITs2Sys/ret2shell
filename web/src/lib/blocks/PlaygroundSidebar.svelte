...
<OverlayScrollbarsComponent
  ...
  defer
>
  <div class={`bg-base-100 border-b border-b-base-content/5 flex flex-col sticky top-0 p-4 h-32`}>
        ...
        {#each tags as tag}
          <li>
            ...
            {#if tagExpandedRecord[tag.id]}
              <ul class="pl-4 relative before:border-l-2 before:absolute before:h-full before:border-l-base-content/10">
